...
urlpatterns = [
    ...
    path("newspapers/<int:pk>/add-redactor/", newspaper_add_redactor, name="redactor-add-newspaper"),
    path("newspapers/<int:pk>/delete-redactor/", newspaper_delete_redactor, name="redactor-delete-newspaper"),
]
